...
public class ShowDetailsActivity extends Activity implements RatingBar.OnRatingBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView title = findViewById(R.id.show_details_title);
        title.setText(currentSong.getTitle());

        TextView artist = findViewById(R.id.show_details_artist);
        artist.setText(currentSong.getArtist());


        TextView filename = findViewById(R.id.show_details_filename);
        filename.setText(currentSong.getFilename());

        RatingBar rating = findViewById(R.id.show_details_rating);
