...
import be.lsinf1225gr12.minipoll.minipollapp.MySQLiteHelper;
...
public class User
{
    ...
    public static ArrayList<User> getUtilisateurs() {
        ...
        TestAdapter mDbHelper = new TestAdapter(MiniPollApp.getContext());
        ...
        Cursor cursor = mDbHelper.query(DB_TABLE, colonnes, null, null, null, null, null);
